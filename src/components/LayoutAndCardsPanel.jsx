...
export default function LayoutAndCardsPanel({
  ...
  return (
    <div className="space-y-4 text-xs">
        ...
        <div className="flex items-center justify-between pb-2.5 border-b border-slate-800/80">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col justify-center">
              <h4 className="font-black text-slate-100 text-xs leading-snug mb-0.5">الثيم اللوني وتصنيف العرض</h4>
              <p className="text-[10.5px] text-slate-400 leading-normal">تطبيق الهوية البصرية العقارية الكاملة</p>
            </div>
          </div>
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between mb-1.5">
                  <span className="text-[11px] font-black text-white truncate leading-snug">{theme.categoryLabel}</span>
                  <span
                ...
                <div className="text-[10px] text-slate-300/85 truncate font-medium leading-normal">{theme.name}</div>
              </button>
            );
          })}
        </div>
      ...
      <div className="p-4 sm:p-5 rounded-2xl bg-slate-900/80 border border-cyan-500/30 space-y-3.5 shadow-[0_0_20px_rgba(0,229,255,0.08)]">
        <div className="flex items-center justify-between pb-2.5 border-b border-cyan-500/20">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-xl bg-cyan-500/20 border border-cyan-500/40 text-cyan-300 flex items-center justify-center font-black shadow-[0_0_8px_rgba(0,229,255,0.4)]">
              <Zap className="w-4 h-4 animate-pulse" />
            </div>
            <div className="flex flex-col justify-center">
              <h4 className="font-black text-white text-xs leading-snug mb-0.5">تأثيرات السايبر نيون المتطورة</h4>
              <p className="text-[10.5px] text-cyan-400/80 leading-normal">توهج ليزري وشبكة نيون أرضية ثلاثية الأبعاد</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5">
          ...
          >
            <div className="text-[11px] leading-snug">⚡ توهج نيون ليزري 100%</div>
          </button>
          ...
          >
            <div className="text-[11px] leading-snug">🌐 شبكة نيون 3D أرضية</div>
          </button>
          ...
          >
            <div className="text-[11px] leading-snug">💡 لمعة نيون للنصوص</div>
          </button>
        </div>
      </div>
      ...
      <div className="p-4 sm:p-5 rounded-2xl bg-slate-900/70 border border-slate-800 space-y-3.5 shadow-sm">
        <div className="flex items-center justify-between pb-2.5 border-b border-slate-800/80">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col justify-center">
              <h4 className="font-black text-slate-100 text-xs leading-snug mb-0.5">تشطيب ونقاء زجاج القالب</h4>
              <p className="text-[10.5px] text-slate-400 leading-normal">انعكاسات زجاجية بلمعة أو ملمس مخملي مطفي</p>
            </div>
          </div>
      ...
      <div className="p-4 sm:p-5 rounded-2xl bg-slate-900/70 border border-slate-800 space-y-3.5 shadow-sm">
        <div className="flex items-center justify-between pb-2.5 border-b border-slate-800/80">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col justify-center">
              <h4 className="font-black text-slate-100 text-xs leading-snug mb-0.5">أبعاد وتناسب البوكس والزجاج</h4>
              <p className="text-[10.5px] text-slate-400 leading-normal">العرض، الهامش، الموقع الرأسي، والشفافية الكريستالية</p>
            </div>
          </div>
      ...
      <div className="p-4 sm:p-5 rounded-2xl bg-slate-900/70 border border-slate-800 space-y-3.5 shadow-sm">
        <div className="flex items-center justify-between pb-2.5 border-b border-slate-800/80">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col justify-center">
              <h4 className="font-black text-slate-100 text-xs leading-snug mb-0.5">حدود البوكس والتوهج</h4>
              <p className="text-[10.5px] text-slate-400 leading-normal">سماكة الإطار، انحناء الزوايا، وتأثير الهالة المشعة</p>
            </div>
          </div>
        ...
        {borderMode === 'custom' && (
          <div className="flex items-center gap-4 pt-1 bg-slate-950/40 p-2.5 rounded-xl border border-slate-800">
      ...
      <div className="p-4 sm:p-5 rounded-2xl bg-slate-900/70 border border-slate-800 space-y-3.5 shadow-md">
        <div className="flex items-center justify-between pb-2.5 border-b border-slate-800/80">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-xl bg-amber-500/15 border border-amber-500/30 text-amber-400 flex items-center justify-center font-black shadow-inner">
            ...
            <div className="flex flex-col justify-center">
              <h4 className="font-black text-slate-100 text-xs leading-snug mb-0.5">استوديو الفواصل المعمارية والسينمائية</h4>
              <p className="text-[10.5px] text-slate-400 leading-normal">16 نمطاً هندسياً وتحريرياً مع تحكم كامل بالسماكة والسطوع</p>
            </div>
          </div>
          <span className="text-[9px] font-extrabold text-amber-400 bg-amber-400/10 px-2 py-0.5 rounded-full border border-amber-400/20">
            DIVIDERS
